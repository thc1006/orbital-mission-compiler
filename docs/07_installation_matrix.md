...
| Pydantic | `pydantic` | https://docs.pydantic.dev/latest/ ; https://github.com/pydantic/pydantic/releases | **2.12.5** | `pip install pydantic==2.12.5` | Python >=3.9 | check downstream libs expecting pydantic v1 |
| Hera | `hera-workflows` | https://pypi.org/project/hera-workflows/ | **6.0.0** | `pip install hera-workflows==6.0.0` | Python only | keep aligned with Argo API expectations |
